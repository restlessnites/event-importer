...
async def get_event_statistics() -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve event statistics: {str(e)}"
        ) from e
...
async def get_submission_statistics() -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to retrieve submission statistics: {str(e)}",
        ) from e
...
async def get_combined_statistics() -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve combined statistics: {str(e)}"
        ) from e
...
async def get_event_trends(days: int | None = 7) -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve event trends: {str(e)}"
        ) from e
...
async def get_detailed_statistics() -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve detailed statistics: {str(e)}"
        ) from e
