...
async def get_submission_statistics() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve submission statistics: {str(e)}")
...
async def get_combined_statistics() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve combined statistics: {str(e)}")


@router.get("/trends")
async def get_event_trends(days: Optional[int] = 7) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve event trends: {str(e)}")
...
async def get_detailed_statistics() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve detailed statistics: {str(e)}")
