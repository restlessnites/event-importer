...
async def get_event_statistics() -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve event statistics: {e!s}",
        ) from e
...
async def get_combined_statistics() -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve combined statistics: {e!s}",
        ) from e
...
async def get_event_trends(days: int | None = 7) -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve event trends: {e!s}",
        ) from e
...
async def get_detailed_statistics() -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve detailed statistics: {e!s}",
        ) from e
